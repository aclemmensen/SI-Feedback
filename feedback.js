/**
 * @author Asbjørn Clemmensen <ac@siteimprove.com>
 * @package siteanalyze_ng
 */

/**
 * Du skal give mig et array med config objekter i _szfb_config nedenfor.
 * Disse configs skal være konfigureret som objektet defaults i objektet
 * under jQuery.
 *
 * Jeg scanner dette array for at finde ud af, om en given config skal
 * vises eller ej (om det matcher på include og ikke matcher på exclude,
 * eller om force er sat eller ej).
 *
 * Hvert config object bliver merget med defaults, for at tilføje de
 * indstillinger, som evt. ikke er sat. Dette er mest en fallback-løsning,
...
/**
 * Configs for opts.layout.preset som giver mening. En sprite kan indeholde
 * 2, 3 eller 5 positioner. Nogle gange kommer den negative først (stjerner,
 * smileys og numre), andre gange kommer den sidst (janej, thumbs).
 */
